...
<form action="{{URL::route('post-add-page')}}" method="post" file ="true" enctype="multipart/form-data"> 
...
<div class="form-group">
<label class="col-lg-2 control-label" for="">Your Image: </label>
<div class="col-lg-6">
...
<div class="col-lg-6">
<textarea name="lyrics" cols="57" rows="7"></textarea>
